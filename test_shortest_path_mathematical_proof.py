...
from shortest_path_navigation_engine import PathResult, ShortestPathEngine
...
def test_astar_optimality():
    ...
    optimal_cost = 8
    costs_match = (
        result_dijkstra.total_cost == optimal_cost
        and result_astar.total_cost == optimal_cost
    )
